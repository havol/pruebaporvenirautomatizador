...
public class IsUserDelete implements Question<Boolean> {

    private final String srtCode;

    public IsUserDelete(String srtCode) {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        return String.valueOf(codeResp).equals(srtCode);
    }

    public static IsUserDelete successfullyCode(String srtCode) {
        return new IsUserDelete(srtCode);
    }
